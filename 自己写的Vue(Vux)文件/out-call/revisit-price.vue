...
<template>
  <div class="main">
    ...
    <div class="footer" v-show='showFooter' v-if='ElectricitySalesJob.id'>
      <div class="item">
          ...
          <div class="more">
            ...
            <label class="more-content" style="width:calc(100% - 120px)">{{ElectricitySalesJob.updateTime | formatData}}</label>
          </div>
          <div class="handel">
...
export default {
  ...
  created () {
    ...
    this.ElectricitySalesJob = this.storage.get('ElectricitySalesJob')
    if (this.ElectricitySalesJob) {
  ...
  methods: {
    ...
    showHandleResultChange (value) {
      this.storage.set('ElectricitySalesJob', this.ElectricitySalesJob)
