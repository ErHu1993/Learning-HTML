      ...
      _this.$http.get(_this.host_bdd + '/autoInsurance/v1/cities/vendor/' +
                ...
                .then((rt) => {
                  ...
                  if (rt.data.codeCities) {
                    ...
                    var cities = _this.codeCities[0]
                    var children = cities.children[0]
                    _this.addressValue.push(cities.nameCn)
                    _this.addressValue.push(children.nameCn)
                    _this.currentCityCode = children
